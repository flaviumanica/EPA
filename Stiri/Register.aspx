...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class= "tab" align="center">
        ...
        <asp:RequiredFieldValidator CssClass="valid"
                    ...
                    ErrorMessage="Confirmarea parolei este obligatorie!"
                    ForeColor="Red">*</asp:RequiredFieldValidator>
        ...
        <asp:CompareValidator CssClass="valid"
                    ...
                    ControlToValidate="Data"
                    ErrorMessage="Introdu o data valida!">
        ...
        <asp:Literal
         ...
         <asp:Button class="but" ID="Button2" runat="server" Text="Creeaza cont" OnClick="Adauga_user" Height="45px" Width="283px" />
    </div>
